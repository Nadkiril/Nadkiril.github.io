const imagesData = [
    {photo: 'https://cdn.pixabay.com/photo/2016/09/04/12/05/sunflower-1643794_960_720.jpg', title: 'Méhek élete', description: 'Általános tudnivalók.'},
    ...
    {photo: 'https://cdn.pixabay.com/photo/2015/07/01/10/55/honeycomb-827476_960_720.jpg', title: 'Lép', description: 'A méhek ezen fejlődnek. Fejlődés szakaszai: pete/ álca (képen)/ báb, ezt egy szóval fiasításnak nevezik. Dajkaméhek gondozzák őket.'},
   ...
   {photo: 'https://cdn.pixabay.com/photo/2020/04/04/05/48/bees-5000948_960_720.jpg', title: 'Folyadék', description: 'A méhek is megszomjazhatnak. Sekély, tiszta, természetes vízzel érdemes őket itatni, a hálózati csapvíz nem az igazi számukra.'},
     ...
     {photo: 'https://cdn.pixabay.com/photo/2017/04/11/16/58/flower-2222228_960_720.jpg', title: 'Virágzás', description: 'Bármilyen virágzásban lévő növényt TILOS vegyszerrel permetezni nappal, napnyugta előtt!'},
     ...
     {photo: 'https://cdn.pixabay.com/photo/2020/02/20/08/24/bird-4864225_960_720.jpg', title: 'Gyurgyalagfélék', description: 'Ezek a kis banditák a méhészetek legfőbb kártevői, ellenségei, egyszerűen megeszi a méheket.'},
